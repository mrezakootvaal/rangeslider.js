...
(function(factory) {
    ...
    function Plugin(element, options) {
		...
		if(this.direction == 'rtl'){
			this.$fill	= $('<div class="' + this.options.fillClass + '" style="right:0;" />');
		}else{
			this.$fill	= $('<div class="' + this.options.fillClass + '" style="left:0;" />');
		}
    ...
    Plugin.prototype.handleDown = function(e) {
		...
		if(this.direction == 'rtl')
        	var rangeX  = this.$range[0].getBoundingClientRect().right;
		else
        	var rangeX  = this.$range[0].getBoundingClientRect().left;
        var handleX = this.getPositionFromNode(this.$handle[0]) + rangeX;
    ...
    Plugin.prototype.setPosition = function(pos) {
        ...
        arrow = this.getPositionFromValue(value);
		
        // Update ui
        this.$fill[0].style.width = (arrow + this.grabX) + 'px';
		if(this.direction == 'rtl')
        	this.$handle[0].style.right = arrow + 'px';
		else
        	this.$handle[0].style.left = arrow + 'px';
        this.setValue(value);
